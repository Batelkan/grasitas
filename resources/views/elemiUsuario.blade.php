        ...
        <div class=" p-3 w-100" aria-labelledby="searchDropdown">
          <form class="form-inline mr-auto w-100 navbar-search">
            <div class="input-group">
              <input type="text" class="form-control bg-light border-0 small" placeholder="Eliminar Usuario..." aria-label="Search" aria-describedby="basic-addon2">
          ...
          <form>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <input readonly value="9999 545667" type="text" class="form-control" id="usrNombre" aria-describedby="nombre" placeholder="Ingresa el numero telefonico">
               </div>
               <div class="form-group">
